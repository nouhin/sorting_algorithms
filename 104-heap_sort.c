 ...
 * Description: The heap property is that every node is greater
 */
	...
	size_t arraySize)
{
	...
	if (leftChildIndex < endIndex && heapArray[leftChildIndex] > heapArray[largestIndex])
		largestIndex = leftChildIndex;
	if (rightChildIndex < endIndex && heapArray[rightChildIndex] > heapArray[largestIndex])
